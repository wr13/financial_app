...
# get information from quandl for FCFF calulation
...
ebitda_data <- data_amd$ebitda
data_ebitda_period <- data_amd[,c("reportperiod","ebit", "quarter")]
data_ebitda_period
recent_ebitda <- recent_subset$ebitda
recent_ebitda
# taxes
